package com.wiprojuly18th.MyFirstMavenProject.LabSession18_08;
...
public class Labsession2_Bookingflow {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        clickEvent(driver, "//input[@id='p-first-name']","Satyajit");
        clickEvent(driver, "//input[@id='p-last-name']","Pradhan");
        clickEvent(driver, "//input[@id='p-email']","xyz@gmail.com");
...
//        clickEvent(driver, "//div[@class='dropdown-menu show']//input[@aria-label='Search']","India");
        ...
        clickEvent(driver, "//input[@name='firstname_1']", "Satyajit");
        clickEvent(driver, "//input[@name='lastname_1']", "Pradhan");
        Thread.sleep(500);
